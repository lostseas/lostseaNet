...
namespace lostsea.Net.Common.SMS
{
    /// <summary>
    /// 短信信息帮助类
    /// </summary>
    public static class SMSHelpter
    {
        //短信秘钥和key
        private readonly static string accessKeyId = XmlHelpter.GetValueByKey("SMSKey");
        private readonly static string accessKeySecret = XmlHelpter.GetValueByKey("SMSSecret");
        ...
        public static SendSmsResponse sendSms(string phoneNumber)
        {
            ...
            try
            {
                ...
                //必填:短信签名-可在短信控制台中找到
                request.SignName = "迷失海洋";
                //必填:短信模板-可在短信控制台中找到
                request.TemplateCode = "SMS_102295051";
                //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
                request.TemplateParam = "{\"code\":\"123\"}";
                //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
                request.OutId = DateTime.Now.ToString("yyyyMMddHHmmssfff");
